...
/**
[Mã câu hỏi (qCode): IGMisjbU].  Một chương trình server hỗ trợ kết nối qua giao thức TCP 
* tại cổng 2206 (hỗ trợ thời gian giao tiếp tối đa cho mỗi yêu cầu là 5s). 
Yêu cầu xây dựng chương trình client thực hiện kết nối tới server trên sử dụng luồng byte 
* dữ liệu (InputStream/OutputStream) để trao đổi thông tin theo thứ tự: 
a.	Gửi mã sinh viên và mã câu hỏi theo định dạng "studentCode;qCode". 
* Ví dụ: "B16DCCN999;C64967DD"
b.	Nhận dữ liệu từ server là một chuỗi gồm các giá trị nguyên được phân tách với
* nhau bằng  "|"
Ex: 2|5|9|11
...
public class ByteStream3 {
    public static void main(String[] args) {
        try {
            ...
            byte[] dataSend = "B21DCCN131;n9bHlcwg".getBytes();
