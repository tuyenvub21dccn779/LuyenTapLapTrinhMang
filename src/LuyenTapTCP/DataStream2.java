...
/**
[Mã câu hỏi (qCode): dPhIx7M7].  Một chương trình servercho phép kết nối qua TCP tại cổng 2207 (hỗ trợ thời gian liên lạc tối đa cho mỗi yêu cầu là 5 giây). Yêu cầu là xây dựng chương trình client tương tác với server bằng các byte stream (DataInputStream/DataOutputStream) để trao đổi thông tin theo trình tự sau:
...
public class DataStream2 {
    public static void main(String[] args) {
        try {
            ...
            String strSend = "B21DCCN023;dPhIx7M7";
