...
/**
[Mã câu hỏi (qCode): 5vHFqlaO].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện 
...
b. Chuyển đổi mảng dữ liệu nhị phân nhận được thành một chuỗi biểu diễn hex. Mỗi byte trong mảng 
* sẽ được chuyển đổi thành hai ký tự hex tương ứng.
