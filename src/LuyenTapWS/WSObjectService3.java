...
/**
[Mã câu hỏi (qCode): BPbKOPvF].  Một dịch vụ web được định nghĩa và mô tả trong tệp 
...
* các công việc sau:
a. Triệu gọi phương thức requestListProject với tham số đầu vào là mã sinh viên (studentCode) 
* và mã câu hỏi (qCode) để nhận về danh sách đối tượng Project từ server. Mỗi đối tượng Project 
* có các thuộc tính:
...
b. Lọc và giữ lại các dự án có completionPercentage từ 80% trở lên và có hạn hoàn thành 
* (dueDate) trong vòng 15 ngày tới (tính từ ngày hiện tại).
c. Triệu gọi phương thức submitListProject(String studentCode, String qCode, 
* List<Project> projects) để gửi danh sách các dự án gần hoàn thành và cần ưu tiên trở lại server. 
