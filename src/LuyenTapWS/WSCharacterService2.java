...
/**
[Mã câu hỏi (qCode): iJuvyk9C].  Một dịch vụ web được định nghĩa và mô tả trong tệp 
...
* submitCharacterStringArray(String studentCode, String qCode, List<String> data) để gửi mảng 
* chuỗi đã sắp xếp trở lại server.
Ví dụ: Nếu mảng chuỗi nhận được từ phương thức requestCharacter là 
* ["apple", "banana", "fig", "pineapple"] mảng sắp xếp tăng dần theo độ dài sẽ là 
* ["fig", "apple", "banana", "pineapple"].
